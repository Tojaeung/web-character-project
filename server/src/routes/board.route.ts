...
// 게시글 이미지 업로드 안할시
router.post('/boards/:board/posts/image', auth, validator(deleteImageKeySchema), asyncHandler(removeImageKey));

// 게시물 생성
router.post('/boards/:board/posts', auth, validator(createPostSchema), asyncHandler(createPost));
// 게시물 변경
...
// 게시물 댓글 생성
router.post('/boards/:board/posts/:postId/comments', auth, validator(createCommentSchema), asyncHandler(createComment));
// 게시물 댓글 변경
...
// 게시물 좋아요 생성
router.post('/boards/:board/posts/:id/like', auth, validator(createLikeSchema), asyncHandler(createLike));
// 게시물 싫어요 생성
router.post('/boards/:board/posts/:id/dislike', auth, validator(createDisLikeSchema), asyncHandler(createDisLike));
